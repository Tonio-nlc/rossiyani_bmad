...
export const TEACHING_GRAPH_EDGES: TConceptGraphEdge[] = [
  ...
  { fromId: "case-accusative", toId: "noun-declension", relation: "extends" },
  { fromId: "noun-animacy", toId: "case-accusative", relation: "extends" },
  { fromId: "noun-animacy", toId: "noun-declension", relation: "extends" },
  { fromId: "noun-animacy", toId: "noun-gender", relation: "related" },
  { fromId: "case-accusative", toId: "preposition-government", relation: "related" },
  { fromId: "case-genitive", toId: "noun-declension", relation: "extends" },
  { fromId: "case-genitive", toId: "case-accusative", relation: "related" },
  { fromId: "case-genitive", toId: "preposition-government", relation: "related" },
  { fromId: "case-dative", toId: "noun-declension", relation: "extends" },
  { fromId: "case-dative", toId: "case-accusative", relation: "related" },
  { fromId: "case-dative", toId: "preposition-government", relation: "related" },
  { fromId: "case-instrumental", toId: "noun-declension", relation: "extends" },
  { fromId: "case-instrumental", toId: "case-accusative", relation: "related" },
  { fromId: "case-instrumental", toId: "preposition-government", relation: "related" },
  { fromId: "case-prepositional", toId: "noun-declension", relation: "extends" },
  { fromId: "case-prepositional", toId: "case-accusative", relation: "related" },
  { fromId: "case-prepositional", toId: "preposition-government", relation: "related" },
  { fromId: "case-nominative", toId: "noun-declension", relation: "extends" },
  { fromId: "case-nominative", toId: "case-accusative", relation: "related" },
  { fromId: "verb-past-tense", toId: "verb-present-conjugation", relation: "related" },
  { fromId: "verb-past-tense", toId: "verb-perfective-aspect", relation: "related" },
