...
**Story 5.4 — Branding** — logos, favicon, wording FR (voir [`docs/design/STORIES.md`](./design/STORIES.md))
...
| 5.2 Standardisation DS | ✅ [`DESIGN_SYSTEM.md`](./design/DESIGN_SYSTEM.md) § Tokens |
| 5.3 Layouts & headers | ✅ [`DESIGN_SYSTEM.md`](./design/DESIGN_SYSTEM.md) § Layouts |
| 5.4 Branding | À faire |
| 5.5 Polish ciblé (fondateur) | À faire |
...
1. **Epic 5** — Audit (5.1 ✅) → Tokens (5.2 ✅) → Layouts (5.3 ✅) → Branding (5.4) → Polish fondateur (5.5)
2. **Design Freeze**
